...
?>
	<div class="content">
	  <div class="container">
		<h1>Produto</h1>
		<form class="form-control" action="/lojamvc/inserirProduto" method="POST" enctype="multipart/form-data">
			<div class="mb-3">
			...
			<div class="mb-3">
				...
				<input type="text" class="form-control" id="desconto" name="desconto" value="<?php echo isset($_POST['desconto'])?$_POST['desconto']:''?>">
